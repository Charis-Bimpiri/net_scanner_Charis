...
2. The scanner attempts a TCP connection on each port from 1 to 1024
3. Open ports are identified and matched to known services
4. A report is generated and saved to the `reports/` directory
